    ...
    <footer className="border-t border-slate-200 bg-white py-12 dark:border-white/10 dark:bg-slate-950">
      <Container>
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div><h3 className="font-semibold text-primary dark:text-white">Contact</h3><div className="mt-4 space-y-3 text-sm text-mutedText dark:text-slate-400"><p className="flex items-center gap-2"><Mail size={16} />{siteConfig.contact.email}</p><p className="flex items-center gap-2"><Send size={16} />{siteConfig.contact.telegram}</p><p className="flex items-center gap-2"><MessageCircle size={16} />{siteConfig.contact.line}</p><p className="flex items-center gap-2"><Phone size={16} />WhatsApp Contact</p><p className="flex items-center gap-2"><Globe size={16} />{siteConfig.contact.website}</p></div></div>
